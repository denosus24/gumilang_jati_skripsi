<div class="flex min-h-screen flex-col items-center my-16">
    <div class="flex w-full flex-grow items-center justify-center">
        <main
            ...
            <h1 class="text-center text-xl font-medium mb-8">Daftar Akun Gumilang Jati</h1>

            <div class="text-sm text-center mb-8">
                <p>Sudah punya akun? {{ $this->loginAction }}</p>
            </div>

            <x-filament-panels::form wire:submit="registerWithRedirection">
                {{ $this->form }}
