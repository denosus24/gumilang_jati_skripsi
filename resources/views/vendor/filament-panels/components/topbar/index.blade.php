...
<div
    ...
    <nav class="flex h-20 items-center gap-x-4 px-4 bg-white shadow dark:bg-gray-900 dark:ring-white/10 md:px-6 lg:px-8">
        ...
        @if (filament()->auth()->check())
            <div x-persist="topbar.start" class="ms-auto py-5 flex items-center gap-x-4">
                @if (filament()->auth()->check())
                    <span class="text-gray-50 text-sm">{{ auth()->user()->name }}</span>
