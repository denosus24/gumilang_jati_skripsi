...
>
    <a
        ...
        @class([
            ...
            'hover:bg-primary-500 focus-visible:bg-gray-100 dark:hover:bg-white/5 dark:focus-visible:bg-white/5' => filled($url),
            'bg-gradient-to-b from-primary-600 to-primary-700 dark:bg-white/5' => $active,
        ])
    >
