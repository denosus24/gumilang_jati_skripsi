        ...
        ...(
            $outlined ?
                ...
                [
                    ...
                    'bg-custom-500 text-white hover:bg-custom-700 focus-visible:ring-custom-500/50 dark:bg-custom-500 dark:hover:bg-custom-400 dark:focus-visible:ring-custom-400/50' => ($color !== 'gray') && ($tag !== 'label'),
